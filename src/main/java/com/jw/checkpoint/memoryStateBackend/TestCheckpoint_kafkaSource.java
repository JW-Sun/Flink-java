package com.jw.checkpoint.memoryStateBackend;
...
public class TestCheckpoint_kafkaSource {
    public static void main(String[] args) throws Exception {
        ...
        StateBackend stateBackend = new MemoryStateBackend(5 * 1024 * 1024, true);
        ...
        sum.map(new MapFunction<Wc, String>() {
            ...
            public String map(Wc value) throws Exception {
                ...
                .addSink(new KafkaUtil().getFlinkKafkaProducer("test"));
